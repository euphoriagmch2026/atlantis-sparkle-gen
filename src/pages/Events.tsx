...
const Events = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Events & Competitions | EUPHORIA 2026</title>
        <meta
          name="description"
          content="Explore music, dance, literary, and gaming competitions at EUPHORIA 2026."
        />
      </Helmet>
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="font-cinzel text-4xl md:text-5xl font-bold text-foreground mb-4">
              <span className="text-primary text-glow">Events</span> &
              Competitions
            </h1>
      ...
      {totalItems > 0 && (
        <div className="fixed bottom-6 right-6 z-40">
          ...
          >
            <ShoppingCart className="w-5 h-5 mr-2" /> Checkout (₹{totalAmount})
          </Button>
        </div>
      )}
