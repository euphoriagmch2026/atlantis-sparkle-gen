...
const PreEvents = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      ...
      if (!error && data) setEvents(data as PreEvent[]);
      setLoading(false);
    };
    fetchEvents();
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      <Helmet>
        <title>Pre-Euphoria & Offstage Events | EUPHORIA 2026</title>
        <meta
          name="description"
          content="Join the hype! Register for Pre-Euphoria events or join WhatsApp groups for Offstage updates."
        />
      </Helmet>
      <FloatingParticles />
      <Navbar />
